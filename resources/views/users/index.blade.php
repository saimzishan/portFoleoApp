...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- Portfolio-CSS -->	<link rel="stylesheet" href="/uAssets/css/swipebox.css" type="text/css" media="all">

    <link href="/uAssets/css/aos.css" rel="stylesheet" type="text/css" media="all" /><!-- //animation effects-css-->

    <link rel="stylesheet" href="/uAssets/css/index.css"><!-- skills bars CSS-->

    <!-- custom-theme -->
    <link href="/uAssets/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <link href="/uAssets/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- //custom-theme -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modalpad">
                    <div class="modalpop ">
                        <img src="/uAssets/images/1.jpeg" class="img-responsive" alt=""/>
                    </div>
...
<div class="about" id="about">
    ...
    <div class="col-md-6 about-left">
        ...
        <img src="/uAssets/images/signature.jpg" alt="" />
    </div>
    <div data-aos="flip-right" class="col-md-6 about-right">
        <img src="/uAssets/images/about.jpg" alt="" />
    </div>
    <div class="clearfix"></div>
</div>
<!-- //about -->
            ...
            <div class="col-md-6 skill-grids-left">
                <div data-aos="flip-left" class="col-md-6 w3labout-img">
                    <div class="boxw3-agile">
                        <img src="/uAssets/images/s1.jpg" alt="" class="img-responsive" />
                ...
                <div data-aos="flip-right" class="col-md-6 w3labout-img">
                    <div class="boxw3-agile">
                        <img src="/uAssets/images/s2.jpg" alt="" class="img-responsive" />
                        <div class="agile-caption">
                            <h3>Php</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                        </div>
                ...
                <div  data-aos="flip-left" class="col-md-6 w3labout-img">
                    <div class="boxw3-agile">
                        <img src="/uAssets/images/s3.jpg" alt="" class="img-responsive" />
                        <div class="agile-caption">
                            <h3>Jquery</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                        </div>
                ...
                <div data-aos="flip-right" class="col-md-6 w3labout-img">
                    <div class="boxw3-agile">
                        <img src="/uAssets/images/s4.jpg" alt="" class="img-responsive" />
                        <div class="agile-caption">
                            <h3>JavaScript</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                        </div>
    ...
    <div class="tabs tabs-style-bar">
        ...
        <div class="content-wrap">
            ...
            <section id="section-bar-1" class="agileits w3layouts">
                ...
                <div class="gallery-grids">
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/5.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/5.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p4.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p4.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p5.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p5.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p6.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p6.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p7.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p7.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p8.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p8.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p9.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p9.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p10.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p10.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p11.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p11.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Web Design</h4>
                                </figcaption>
                            </figure>
            ...
            <section id="section-bar-2" class="agileits w3layouts">
                ...
                <div class="gallery-grids">
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p1.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p1.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p2.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p2.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p3.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p3.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p12.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p12.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/p13.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/p13.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/8.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/8.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/9.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/9.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/6.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/6.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
                    ...
                    <div class="col-md-4 col-sm-4 gallery-top">
                        <a href="/uAssets/images/7.jpg" class="swipebox">
                            <figure class="effect-bubba">
                                <img src="/uAssets/images/7.jpg" alt="" class="img-responsive">
                                <figcaption>
                                    <h4>Mobile Apps</h4>
                                </figcaption>
                            </figure>
...
<!-- js -->
<script type="text/javascript" src="/uAssets/js/jquery-2.1.4.min.js"></script>
<!-- for bootstrap working -->
<script src="/uAssets/js/bootstrap.js"></script>
<!-- //for bootstrap working -->
<!-- //js -->

<!-- Gallery-Tab-JavaScript -->
<script src="/uAssets/js/cbpFWTabs.js"></script>
<script>
    (function() {
...
<script src="/uAssets/js/jquery.swipebox.min.js"></script>
...
<script src="/uAssets/js/scrolling-nav.js"></script>
<!-- //fixed-scroll-nav-js -->

<script src="/uAssets/js/index.js"></script><!-- skills bars JS FILE-->

<!-- animation effects-js files-->
<script src="/uAssets/js/aos.js"></script><!-- //animation effects-js-->
<script src="/uAssets/js/aos1.js"></script><!-- //animation effects-js-->
<!-- animation effects-js files-->

<!-- //here starts scrolling icon -->
<script src="js/SmoothScroll.min.js"></script>
<script type="text/javascript" src="/uAssets/js/move-top.js"></script>
<script type="text/javascript" src="/uAssets/js/easing.js"></script>
